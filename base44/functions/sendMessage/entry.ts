...
export default async function(req) {
  try {
    ...
    // Notify through the shared reliable helper so message delivery and commercial
    // notifications use one bounded-retry/escalation path. A notification failure
    // never rolls back the already-created Message.
