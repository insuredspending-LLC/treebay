...
// Featured placement is a TreEbay editorial/promotional decision — vendors can
...
export default async function(req) {
  try {
    ...
    if (user.role !== "admin") return Response.json({ error: "Only TreEbay administrators can feature a listing." }, { status: 403 });
